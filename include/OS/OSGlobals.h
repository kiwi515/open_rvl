...
OS_DEF_GLOBAL_VAR(u16, GC_PAD_4_BTN,                  0x800030E4);
 ...
 */
// clang-format off
OS_DEF_HW_REG(volatile u16, VI_DCR,   0xCC002002);
OS_DEF_HW_REG(volatile u16, VI_VICLK, 0xCC00206C);
OS_DEF_HW_REG(volatile u16, VI_VISEL, 0xCC00206E);
// clang-format on
