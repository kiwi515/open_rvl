...
DEFAULT_CFLAGS = "-msgstyle gcc -lang c -enum int -inline auto -ipa file -volatileasm -Cpp_exceptions off -RTTI off -proc gekko -fp hard -I- -Iinclude -ir include -nodefaults -w unused,missingreturn,err"
DEFAULT_OPT = "-O4,p"
